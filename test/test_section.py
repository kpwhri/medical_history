...
def test_family_history_section():
    ...
    assert set(d for d in data if d) == {'pcos', 'family history indicates:', 'daughter'}
...
def test_family_history_section_difficult():
    ...
    assert set(d for d in data if d) == {'pcos', 'family history indicates:', 'aunt'}
...
def test_personal_history_section_intervening_section():
    ...
    assert set(d for d in data if d) == set()
